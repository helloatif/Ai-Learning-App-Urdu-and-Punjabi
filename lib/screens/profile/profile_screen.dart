  ...
  Widget build(BuildContext context) {
    return Consumer2<UserProvider, GamificationProvider>(
      builder: (context, userProvider, gamification, _) {
        ...
        // Always enforce status bar style
          ...
          child: Scaffold(
            ...
            body: Stack(
              children: [
                Positioned.fill(
                  child: CustomPaint(
                    painter: _DotGridPainter(baseColor: _backgroundBlue),
                  ),
                ),
                Positioned(
                  top: 0,
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        _TopIconButton(
                                          ...
                                          onPressed: () =>
                                              _showComingSoonSnack('Notifications'),
                                        ),
                                      ],
                                    ),
                                  ),
                              ...
                              child: ConstrainedBox(
                                ...
                                child: SingleChildScrollView(
                                  ...
                                  _BentoCard(
                                    ...
                                    accentIcon: null,
                                    riveAsset:
                                        'assets/icons/animations/ai-orb-mascot.riv',
                                    onTap: () {
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
                                  ...
                                  _BentoCard(
                                    ...
                                    accentIcon: null,
                                    riveAsset:
                                        'assets/icons/animations/grammar-checking-emotions.riv',
                                    showTopIcon: false,
                                    onTap: () {
                                      Navigator.of(context).push(
                                        MaterialPageRoute(
              ...
              if (riveAsset != null)
                Positioned(
                  ...
                  child: SizedBox(
                    width: 140,
                    height: 140,
                    child: _RiveCardAnimation(asset: riveAsset!),
                  ),
                )
              else if (accentAsset != null)
                Positioned(
                  right: 8,
                  top: 15,
                  child: Center(
...
class _RiveCardAnimation extends StatefulWidget {
  final String asset;

  const _RiveCardAnimation({required this.asset});

  @override
  State<_RiveCardAnimation> createState() => _RiveCardAnimationState();
}

class _RiveCardAnimationState extends State<_RiveCardAnimation> {
      ...
      builder: (context, constraints) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            borderRadius: BorderRadius.circular(28),
            border: Border.all(
              color: const Color(0xFF7CFC00).withOpacity(0.12),
            ),
          ),
          child: isWide
              ? Row(
